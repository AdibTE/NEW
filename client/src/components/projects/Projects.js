...
import { getProjects, clearErrors, getUserProjects,getMyProjects, search } from '../../actions/projectActions';
							...
							<Fragment>
								...
								{userType === 2 && (
									<span
										value="my"
										onClick={filterHandler}
										{...filter === 'my' && { className: 'active' }}
									>
										<i className={filter === 'my' ? 'fas fa-check-circle' : 'far fa-circle'} />
                                        پروژه های من
									</span>
								)}
							</Fragment>
...
export default connect(mapStateToProps, { getProjects, clearErrors, getUserProjects,getMyProjects, search })(Projects);
